...
registered_domains = ['test.com', 'test100.domain', 'www.test100.domain', 'test101.domain'] # replace into already registered domains.

# Functions
def random_name():
    return random.choice(registered_domains)
